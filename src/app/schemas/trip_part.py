...
class TripPartBase(BaseModel):
    ...
    full_name: Annotated[str | None, Field(default=None, max_length=512, examples=["Moalboal, Cebu, Philippines"])]
...
class TripPartUpdate(BaseModel):
    ...
    full_name: Annotated[str | None, Field(default=None, max_length=512)]
